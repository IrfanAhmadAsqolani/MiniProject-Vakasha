            ...
            <div className="text-center text-md-start">
              <div className="row">
                ...
                <div className="col-md-3 col-lg-3 col-xl-3 mb-4 mt-4">
                  ...
                  <hr className="mb-4 mt-0 d-inline-block mx-auto" id='garis-footer'/>
                  <p><i className="bi bi-house-door-fill mr-3" />&emsp;Menara Standard Chartered<br/> &emsp;&emsp;Setiabudi, JKT, 12930, ID</p>
                  <p><i className="bi bi-envelope mr-3" /> &emsp;info@Vakasha.com</p>
                  <p><i className="bi bi-telephone-fill mr-3" /> &emsp;(021) 7301018</p>
                </div>
