                    ...
                    <div className="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
                        <ul className="navbar-nav mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="/"><strong id='size-teks'>HOME</strong></a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" href="#"><strong id='size-teks'>LOG IN</strong></a>
                            </li>
                            <li className="nav-item btn-signup pe-0">
                                <a href="#"><button className="btn" id="btn-signup" type="submit"><strong id='size-teks'>SIGN UP</strong></button></a>
                            </li>
                        </ul>
                    </div>
                </div>
