            ...
            <div className='row me-0'>
                <div className='col-auto mx-auto flex-column justify-content-center aligns-items-center' id='margin-teks'>
                    <div data-aos="fade-up" data-aos-duration="2000">
                        <h1 className='text-white text-center mb-3 shadow'><strong className='size-teks'>FIND BEAUTIFUL PLACES</strong></h1>
                        <h1 className='text-white text-center mb-3 shadow'><strong className='size-teks'>FOR YOUR TRIP</strong></h1>
